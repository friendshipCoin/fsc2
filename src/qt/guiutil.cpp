...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "FriendshipCoin2.lnk";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    else
    {
        ...
        optionFile << "Name=FriendshipCoin2\n";
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("FriendshipCoin2-Qt") + " " + tr("version") + " " +
    ...
    setWindowTitle(tr("FriendshipCoin2-Qt"));
